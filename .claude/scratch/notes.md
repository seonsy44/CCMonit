...
- remove-cost 완료 (2026-04-16). CostEstimationService 삭제 및 ~16개 파일에서 cost/USD 참조 전면 제거. 토큰 수량(input/output/cache/total)만 유지. event-flow, module-responsibilities docs도 정비.
