...
updated: 2026-04-12 (dev-* 체계로 전환 + dev-kickoff 추가)
...
.claude/scratch/
├── notes.md               # 공통 (개발건 무관)
├── worklog.md             # 기본 참조용 (dev-open 없이 dev-sprint 직행 시)
├── next-prompt.md         # 기본 참조용
├── open-questions.md      # 기본 참조용
...
- `.claude/context/*`
- `.claude/scratch/*` (전체 — dev-list 작성을 위해)
- `.claude/scratch/devs/` 하위 디렉토리
