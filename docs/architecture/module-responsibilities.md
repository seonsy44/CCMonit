...
| 토큰 집계 | Telemetry/Token | Domain/Projector | accuracy 포함 |
| 이상 징후 판정 | Alerting | Telemetry/Projector | severity 포함 |
| 세션 리포트 생성 | Reporting | Projector/Telemetry | markdown/json/csv |
